        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent className="space-y-6">
            <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg p-6 text-center">
              ...
              <p className="text-white text-3xl font-bold tracking-wider">{serverIdInfo.serverId}</p>
            </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-yellow-700 dark:text-yellow-400">
                    Please save your Company Server ID. You will need it to log in along with your email and password.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 p-4 rounded">
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm">
                  <p className="font-semibold text-blue-800 dark:text-blue-500 mb-1">Next Steps</p>
                  <p className="text-blue-700 dark:text-blue-400">
                    A verification email has been sent to <strong>{serverIdInfo.email}</strong>. 
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-6">
                  ...
                  <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                    ...
                    <div className="space-y-1 leading-none">
                      <FormLabel className="text-sm font-normal">
                        I accept the <a href="#" className="text-indigo-600 hover:underline">Terms & Conditions</a>
                      </FormLabel>
                      <FormMessage />
                    </div>
                  </FormItem>
          ...
          <div className="text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <a href="/login/admin" className="text-indigo-600 hover:underline font-medium" data-testid="link-login">
              Login here
            </a>
          </div>
        </CardContent>
